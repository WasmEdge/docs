...
const FeatureList = [
    {
        ...
        description: (
            <>
                Develop Wasm apps in Rust, JavaScript, Go, and Python. Those
                apps are compiled into Wasm and run inside the WasmEdge sandbox.
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        description: (
            <>
                Create WasmEdge extensions and plugins in Rust and C/C++.
                Contribute to the WasmEdge project.
            </>
        ),
    },
];
function Feature({ Svg, LinkSvg, LinkUrl, title, description }) {
    return (
        <div className={clsx('col col--4')}>
            ...
            <div
                className={`${styles.hoverStyle} text--center padding-horiz--md`}>
