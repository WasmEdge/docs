...
To enable the WasmEdge WASI-Crypto, developers need to [building the WasmEdge from source](/docs/contribute-guide/source/os/linux.md) with the cmake option `-DWASMEDGE_PLUGIN_WASI_CRYPTO=ON`.
