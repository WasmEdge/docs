...
# 4.4.1 C API 0.12.0 API Documentation
...
5. Specified module instance
    ...
    > Note: For the `WASI-NN` plugin, please check that the [dependencies and prerequisites](/docs/develop-guide/build-and-run/install.md#install-plugins-and-extensions) are satisfied.
    > Note: For the `WASI-Crypto` plugin, please check that the [dependencies and prerequisites](/docs/develop-guide/build-and-run/install.md#install-plugins-and-extensions) are satisfied. And the 5 modules are recommended to all be created and registered together.
