...
The installation steps are no different from the [installation document](/docs/develop/build-and-run/install.md), and the execution is the same. Here's a video about installing WasmEdge and running a simple WebAssembly module to add two numbers up.
