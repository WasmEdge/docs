...
# 6.6.2 Go API 0.11.2 Documentation

The following are the guides to working with the WasmEdge-Go SDK.

**This document is for the `v0.11.2` version. For the older `v0.10.1` version, please refer to the [document here](/docs/embed/go/reference/0.10.1.md).**

**Developers can refer to [here to upgrade to v0.11.0](/docs/embed/go/reference/upgrade_to_0.11.0.md).**
...
Developers must [install the WasmEdge shared library](/docs/develop/build-and-run/install.md) with the same `WasmEdge-go` release or pre-release version.
...
3. [WASI-NN proposal](https://github.com/WebAssembly/wasi-nn)
    ...
    > Note: Please check that the [dependencies and prerequests](/docs/develop/build-and-run/install.md#install-plugins-and-extensions) are satisfied.
...
5. Specified module instance
    ...
    > Note: For the `WASI-NN` plugin, please check that the [dependencies and prerequests](/docs/develop/build-and-run/install.md#install-plugins-and-extensions) are satisfied.
    > Note: For the `WASI-Crypto` plugin, please check that the [dependencies and prerequests](/docs/develop/build-and-run/install.md#install-plugins-and-extensions) are satisfied. And the 5 modules are recommended to all be created and registered together.
