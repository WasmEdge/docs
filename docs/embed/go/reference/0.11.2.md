...
# 6.7.3 Go API 0.11.2 Documentation
...
=======
    > Note: Please check that the [dependencies and prerequests](/docs/develop/build-and-run/install.md#wasi-nn-plugin-with-openvino™-backend) are satisfied.
...
=======
    > Note: Please check that the [dependencies and prerequests](/docs/develop/build-and-run/install.md#wasi-crypto-plugin) are satisfied.
>>>>>>> 6851334bd9d72ef2b38259ad573a8764d02577e4
