...
=======
To instantiate the above example Wasm, the host functions must be registered into WasmEdge. See [Host Functions](/docs/embed/c/reference/0.12.0.md#host-functions) for more details.
