...
[GitHub 儲存庫](https://github.com/second-state/wasmedge-containers-examples/)包含在 Kubernetes + containerd + crun 上執行我們範例應用程式的指令碼與 GitHub Actions。
...
我們假設你已經[安裝並設定 containerd](../../deploy/cri-runtime/containerd-crun.md)以搭配 WasmEdge 容器映像檔運作。
