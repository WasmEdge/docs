...
To enable the WasmEdge WASI-Crypto, developers need to [building the WasmEdge from source](/contribute/source/os/linux) with the cmake option `-DWASMEDGE_PLUGIN_WASI_CRYPTO=ON`.
