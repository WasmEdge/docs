...
We will assume that you have already [installed and configured containerd](../../../develop/deploy/cri-runtime/containerd-crun.md) to work with WasmEdge container images.
