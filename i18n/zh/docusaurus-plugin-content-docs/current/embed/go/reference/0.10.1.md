...
3. Specified module instance
    ...
    > Note: For the `WASI-NN` plugin, please check that the [dependencies and prerequests](/develop/build-and-run/install#install-plugins-and-extensions) are satisfied. Note: For the `WASI-Crypto` plugin, please check that the [dependencies and prerequests](/develop/build-and-run/install#install-plugins-and-extensions) are satisfied. And the 5 modules are recommended to all be created and registered together.
