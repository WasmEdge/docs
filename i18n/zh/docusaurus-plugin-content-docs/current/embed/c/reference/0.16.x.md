...
# C API 0.16.3 Documentation

[WasmEdge C API](https://github.com/WasmEdge/WasmEdge/blob/master/include/api/wasmedge/wasmedge.h) denotes an interface to access the WasmEdge runtime at version `0.16.3`. The following are the guides to working with the C APIs of WasmEdge.

**Developers can refer to [here to upgrade to v0.17.0](upgrade_to_0.17.0).**
